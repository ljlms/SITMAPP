<%-- 
    Document   : Recuperar_contraseña1
    Created on : 5/04/2019, 04:57:46 PM
    Author     : Jhon Baron
--%>
				...
				<tr>
					...
					<td id="td_der" class="td_der"> <!-- Lado derecho -->
						<div class="form-group">
							...
							<div><label for="correo_inp">Ingresar correo electronico</label></div>
							<div><input type="email" name="correo_usuario" placeholder="Correo electronico..." id="correo_inp" class="form-control"></div>

							<div style="margin-bottom: 10 px; margin-top: 10px"></div>

							<div>
							<a class="btn btn-dark" href="recuperar_contraseña2.html" role="button">Siguiente</a>
							</div>
