...
public class NoticiaJpaController implements Serializable {
    ...
    public void create(Noticia noticia) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findNoticia(noticia.getIdNoticia()) != null) {
                throw new PreexistingEntityException("Noticia " + noticia + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
