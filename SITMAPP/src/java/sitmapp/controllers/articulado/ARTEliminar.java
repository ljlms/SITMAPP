 ...
 * @author Jhon Baron
 */
@WebServlet(name = "ARTEliminar", urlPatterns = {"/ARTEliminar"})
public class ARTEliminar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String nombreEmpresa = request.getParameter("NomEmpresa");
            int id =Integer.parseInt( request.getParameter("id"));
            String estado = request.getParameter("estado");
            System.out.println(id);
            //public Articulado(String Codigo_Articulado, String Placa, String Nombre_Empresa, int id, String Estado) {
            Articulado art = new Articulado(CodArticulado, placa, nombreEmpresa, id, estado);
            ArticuladoController.delete(art);
