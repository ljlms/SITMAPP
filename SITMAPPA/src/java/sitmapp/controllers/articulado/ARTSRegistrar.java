...
import sitmapp.controllers.empresa.EmpresaController;
...
public class ARTSRegistrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String nombre_empresa = EmpresaController.NombreEmpresa(id_empresa);
            Articulado art = new Articulado(codigo, placa, nombre_empresa , id_empresa);
            ArticuladoController.save(art);//Guarda
