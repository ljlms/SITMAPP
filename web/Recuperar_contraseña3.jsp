<%-- 
    Document   : Recuperar_contraseña3
    Created on : 5/04/2019, 04:58:52 PM
    Author     : Jhon Baron
--%>
				...
				<tr>
					...
					<td id="td_der" class="td_der"> <!-- Lado derecho -->
						<div class="form-group">
							...
							<div><label for="">Ingrese nueva contraseña</label></div>
							
							<div><input type="password" name="" class="form-control" placeholder="Contraseña" required></div>
							<div style="margin-top: 10px; margin-bottom: 10px"></div>							
							<div><input type="password" name="" class="form-control" placeholder="Confirmar contraseña" required></div>

							<div style="margin-top: 10px; margin-bottom: 10px"></div>
							<div> <input type="submit" name="verificar_codigo" value="Guardar Contraseña" class="form-control btn btn-dark"></div>
